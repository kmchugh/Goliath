 ...
 * @author kmchugh
 */
public class MinimumValueRule extends RuleHandler<java.lang.Object, java.lang.Number, SingleParameterArguments<Number>>
{
    ...
    {
        return "Value of " + tcPropertyName + "[" + toPropertyValue.toString() + "]" + " is smaller than " + toArgs.getParameter().toString();
    }
